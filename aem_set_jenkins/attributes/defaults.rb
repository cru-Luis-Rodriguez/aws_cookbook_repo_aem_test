...
default['aem']['jenkins']['jobs'] = %w{cruorgaem6 Backup_AEM_Production_Author_Repo CruOrgaem6_Auto_Production_DailyContentFlush CruOrgaem6_Manual_Prod_Pub_Designs_DispatcherClear Relay_Authentication_Handler cruorgaem6DispatcherClear cruorgaem6_PROD cruorgaem6_PRODDispatcherClear cruorgaem6_PRODPublish cruorgaem6_UAT cruorgaem6_UATDispatcherClear}
default['aem']['jenkins']['plugin_conf'] = %w{jenkins.plugins.hipchat.HipChatNotifier jenkins.plugins.slack.SlackNotifier hudson.scm.CVSSCM jenkins.plugins.slack.SlackNotifier hudson.tasks.Maven}
